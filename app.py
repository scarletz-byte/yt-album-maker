...
# Update 2026: Menggunakan import langsung dari moviepy (Tanpa .editor)
from moviepy import ImageClip, AudioFileClip, VideoClip, CompositeVideoClip
from natsort import natsorted
from pydub import AudioSegment
from PIL import Image, ImageDraw, ImageFont

# FIX 2026: Atasi error Pillow 10+ (Penghapusan ANTIALIAS)
import PIL.Image
...
# FUNGSI RENDER TEKS (Pengganti TextClip agar Bebas ImageMagick)
def create_text_image(text, fontsize, color=(255, 255, 255), size=(1920, 1080), pos=(0,0), duration=1):
    # Buat kanvas transparan dengan Pillow
    img = Image.new('RGBA', size, (0, 0, 0, 0))
    draw = ImageDraw.Draw(img)
    
    # Mencoba load font standar di server Linux Streamlit Cloud
    try:
    ...
    # Konversi Pillow ke format MoviePy
